...
Use one prompt in each isolated chapter-level chat. These prompts do not authorize a worker to proceed until that chunk’s restricted PDF and page sidecar have both been reconnected and verified by SHA-256. The candidate repository `main` branch was verified at the immutable base commit below, and no `locator-audit/*` branch existed when this launch pack was prepared; every worker must check again and refuse a collision. Every prompt also requires the worker to persist its final publication-bound receipt—not merely its earlier pre-publication receipt—to the chunk-specific Library recovery root after opening the pull request.
...
After the pull request has been created, obtain a fresh GitHub observation of its exact URL, number, open state, head branch and commit, base branch and commit, one-commit history, changed-path allowlist, and public-report blob/file hash. Run `bind-publication` with that observation, then rerun `validate-worker`. Save the resulting final publication-bound `locator-audit-worker-receipt.json` and its receipt-bound `locator-audit-worker-recovery.zip` to the existing Library recovery root `/IndexPDF/subject-index-evaluations/oxford-history-french-revolution-2002-original-published-index/workers/locator-audit/CHUNK-001/`, replacing the earlier pre-publication receipt while preserving the canonical filenames. Verify that the saved final receipt names the exact pull-request URL and head commit and binds the public report, private audit, and recovery ZIP. Do not modify or merge the pull request afterward.
```
...
After the pull request has been created, obtain a fresh GitHub observation of its exact URL, number, open state, head branch and commit, base branch and commit, one-commit history, changed-path allowlist, and public-report blob/file hash. Run `bind-publication` with that observation, then rerun `validate-worker`. Save the resulting final publication-bound `locator-audit-worker-receipt.json` and its receipt-bound `locator-audit-worker-recovery.zip` to the existing Library recovery root `/IndexPDF/subject-index-evaluations/oxford-history-french-revolution-2002-original-published-index/workers/locator-audit/CHUNK-002/`, replacing the earlier pre-publication receipt while preserving the canonical filenames. Verify that the saved final receipt names the exact pull-request URL and head commit and binds the public report, private audit, and recovery ZIP. Do not modify or merge the pull request afterward.
```
...
After the pull request has been created, obtain a fresh GitHub observation of its exact URL, number, open state, head branch and commit, base branch and commit, one-commit history, changed-path allowlist, and public-report blob/file hash. Run `bind-publication` with that observation, then rerun `validate-worker`. Save the resulting final publication-bound `locator-audit-worker-receipt.json` and its receipt-bound `locator-audit-worker-recovery.zip` to the existing Library recovery root `/IndexPDF/subject-index-evaluations/oxford-history-french-revolution-2002-original-published-index/workers/locator-audit/CHUNK-003/`, replacing the earlier pre-publication receipt while preserving the canonical filenames. Verify that the saved final receipt names the exact pull-request URL and head commit and binds the public report, private audit, and recovery ZIP. Do not modify or merge the pull request afterward.
```
...
After the pull request has been created, obtain a fresh GitHub observation of its exact URL, number, open state, head branch and commit, base branch and commit, one-commit history, changed-path allowlist, and public-report blob/file hash. Run `bind-publication` with that observation, then rerun `validate-worker`. Save the resulting final publication-bound `locator-audit-worker-receipt.json` and its receipt-bound `locator-audit-worker-recovery.zip` to the existing Library recovery root `/IndexPDF/subject-index-evaluations/oxford-history-french-revolution-2002-original-published-index/workers/locator-audit/CHUNK-004/`, replacing the earlier pre-publication receipt while preserving the canonical filenames. Verify that the saved final receipt names the exact pull-request URL and head commit and binds the public report, private audit, and recovery ZIP. Do not modify or merge the pull request afterward.
```
...
After the pull request has been created, obtain a fresh GitHub observation of its exact URL, number, open state, head branch and commit, base branch and commit, one-commit history, changed-path allowlist, and public-report blob/file hash. Run `bind-publication` with that observation, then rerun `validate-worker`. Save the resulting final publication-bound `locator-audit-worker-receipt.json` and its receipt-bound `locator-audit-worker-recovery.zip` to the existing Library recovery root `/IndexPDF/subject-index-evaluations/oxford-history-french-revolution-2002-original-published-index/workers/locator-audit/CHUNK-005/`, replacing the earlier pre-publication receipt while preserving the canonical filenames. Verify that the saved final receipt names the exact pull-request URL and head commit and binds the public report, private audit, and recovery ZIP. Do not modify or merge the pull request afterward.
```
...
After the pull request has been created, obtain a fresh GitHub observation of its exact URL, number, open state, head branch and commit, base branch and commit, one-commit history, changed-path allowlist, and public-report blob/file hash. Run `bind-publication` with that observation, then rerun `validate-worker`. Save the resulting final publication-bound `locator-audit-worker-receipt.json` and its receipt-bound `locator-audit-worker-recovery.zip` to the existing Library recovery root `/IndexPDF/subject-index-evaluations/oxford-history-french-revolution-2002-original-published-index/workers/locator-audit/CHUNK-006/`, replacing the earlier pre-publication receipt while preserving the canonical filenames. Verify that the saved final receipt names the exact pull-request URL and head commit and binds the public report, private audit, and recovery ZIP. Do not modify or merge the pull request afterward.
```
...
After the pull request has been created, obtain a fresh GitHub observation of its exact URL, number, open state, head branch and commit, base branch and commit, one-commit history, changed-path allowlist, and public-report blob/file hash. Run `bind-publication` with that observation, then rerun `validate-worker`. Save the resulting final publication-bound `locator-audit-worker-receipt.json` and its receipt-bound `locator-audit-worker-recovery.zip` to the existing Library recovery root `/IndexPDF/subject-index-evaluations/oxford-history-french-revolution-2002-original-published-index/workers/locator-audit/CHUNK-007/`, replacing the earlier pre-publication receipt while preserving the canonical filenames. Verify that the saved final receipt names the exact pull-request URL and head commit and binds the public report, private audit, and recovery ZIP. Do not modify or merge the pull request afterward.
```
...
After the pull request has been created, obtain a fresh GitHub observation of its exact URL, number, open state, head branch and commit, base branch and commit, one-commit history, changed-path allowlist, and public-report blob/file hash. Run `bind-publication` with that observation, then rerun `validate-worker`. Save the resulting final publication-bound `locator-audit-worker-receipt.json` and its receipt-bound `locator-audit-worker-recovery.zip` to the existing Library recovery root `/IndexPDF/subject-index-evaluations/oxford-history-french-revolution-2002-original-published-index/workers/locator-audit/CHUNK-008/`, replacing the earlier pre-publication receipt while preserving the canonical filenames. Verify that the saved final receipt names the exact pull-request URL and head commit and binds the public report, private audit, and recovery ZIP. Do not modify or merge the pull request afterward.
```
...
After the pull request has been created, obtain a fresh GitHub observation of its exact URL, number, open state, head branch and commit, base branch and commit, one-commit history, changed-path allowlist, and public-report blob/file hash. Run `bind-publication` with that observation, then rerun `validate-worker`. Save the resulting final publication-bound `locator-audit-worker-receipt.json` and its receipt-bound `locator-audit-worker-recovery.zip` to the existing Library recovery root `/IndexPDF/subject-index-evaluations/oxford-history-french-revolution-2002-original-published-index/workers/locator-audit/CHUNK-009/`, replacing the earlier pre-publication receipt while preserving the canonical filenames. Verify that the saved final receipt names the exact pull-request URL and head commit and binds the public report, private audit, and recovery ZIP. Do not modify or merge the pull request afterward.
```
...
After the pull request has been created, obtain a fresh GitHub observation of its exact URL, number, open state, head branch and commit, base branch and commit, one-commit history, changed-path allowlist, and public-report blob/file hash. Run `bind-publication` with that observation, then rerun `validate-worker`. Save the resulting final publication-bound `locator-audit-worker-receipt.json` and its receipt-bound `locator-audit-worker-recovery.zip` to the existing Library recovery root `/IndexPDF/subject-index-evaluations/oxford-history-french-revolution-2002-original-published-index/workers/locator-audit/CHUNK-010/`, replacing the earlier pre-publication receipt while preserving the canonical filenames. Verify that the saved final receipt names the exact pull-request URL and head commit and binds the public report, private audit, and recovery ZIP. Do not modify or merge the pull request afterward.
```
...
After the pull request has been created, obtain a fresh GitHub observation of its exact URL, number, open state, head branch and commit, base branch and commit, one-commit history, changed-path allowlist, and public-report blob/file hash. Run `bind-publication` with that observation, then rerun `validate-worker`. Save the resulting final publication-bound `locator-audit-worker-receipt.json` and its receipt-bound `locator-audit-worker-recovery.zip` to the existing Library recovery root `/IndexPDF/subject-index-evaluations/oxford-history-french-revolution-2002-original-published-index/workers/locator-audit/CHUNK-011/`, replacing the earlier pre-publication receipt while preserving the canonical filenames. Verify that the saved final receipt names the exact pull-request URL and head commit and binds the public report, private audit, and recovery ZIP. Do not modify or merge the pull request afterward.
```
...
After the pull request has been created, obtain a fresh GitHub observation of its exact URL, number, open state, head branch and commit, base branch and commit, one-commit history, changed-path allowlist, and public-report blob/file hash. Run `bind-publication` with that observation, then rerun `validate-worker`. Save the resulting final publication-bound `locator-audit-worker-receipt.json` and its receipt-bound `locator-audit-worker-recovery.zip` to the existing Library recovery root `/IndexPDF/subject-index-evaluations/oxford-history-french-revolution-2002-original-published-index/workers/locator-audit/CHUNK-012/`, replacing the earlier pre-publication receipt while preserving the canonical filenames. Verify that the saved final receipt names the exact pull-request URL and head commit and binds the public report, private audit, and recovery ZIP. Do not modify or merge the pull request afterward.
```
...
After the pull request has been created, obtain a fresh GitHub observation of its exact URL, number, open state, head branch and commit, base branch and commit, one-commit history, changed-path allowlist, and public-report blob/file hash. Run `bind-publication` with that observation, then rerun `validate-worker`. Save the resulting final publication-bound `locator-audit-worker-receipt.json` and its receipt-bound `locator-audit-worker-recovery.zip` to the existing Library recovery root `/IndexPDF/subject-index-evaluations/oxford-history-french-revolution-2002-original-published-index/workers/locator-audit/CHUNK-013/`, replacing the earlier pre-publication receipt while preserving the canonical filenames. Verify that the saved final receipt names the exact pull-request URL and head commit and binds the public report, private audit, and recovery ZIP. Do not modify or merge the pull request afterward.
```
...
After the pull request has been created, obtain a fresh GitHub observation of its exact URL, number, open state, head branch and commit, base branch and commit, one-commit history, changed-path allowlist, and public-report blob/file hash. Run `bind-publication` with that observation, then rerun `validate-worker`. Save the resulting final publication-bound `locator-audit-worker-receipt.json` and its receipt-bound `locator-audit-worker-recovery.zip` to the existing Library recovery root `/IndexPDF/subject-index-evaluations/oxford-history-french-revolution-2002-original-published-index/workers/locator-audit/CHUNK-014/`, replacing the earlier pre-publication receipt while preserving the canonical filenames. Verify that the saved final receipt names the exact pull-request URL and head commit and binds the public report, private audit, and recovery ZIP. Do not modify or merge the pull request afterward.
```
...
After the pull request has been created, obtain a fresh GitHub observation of its exact URL, number, open state, head branch and commit, base branch and commit, one-commit history, changed-path allowlist, and public-report blob/file hash. Run `bind-publication` with that observation, then rerun `validate-worker`. Save the resulting final publication-bound `locator-audit-worker-receipt.json` and its receipt-bound `locator-audit-worker-recovery.zip` to the existing Library recovery root `/IndexPDF/subject-index-evaluations/oxford-history-french-revolution-2002-original-published-index/workers/locator-audit/CHUNK-015/`, replacing the earlier pre-publication receipt while preserving the canonical filenames. Verify that the saved final receipt names the exact pull-request URL and head commit and binds the public report, private audit, and recovery ZIP. Do not modify or merge the pull request afterward.
```
...
After the pull request has been created, obtain a fresh GitHub observation of its exact URL, number, open state, head branch and commit, base branch and commit, one-commit history, changed-path allowlist, and public-report blob/file hash. Run `bind-publication` with that observation, then rerun `validate-worker`. Save the resulting final publication-bound `locator-audit-worker-receipt.json` and its receipt-bound `locator-audit-worker-recovery.zip` to the existing Library recovery root `/IndexPDF/subject-index-evaluations/oxford-history-french-revolution-2002-original-published-index/workers/locator-audit/CHUNK-016/`, replacing the earlier pre-publication receipt while preserving the canonical filenames. Verify that the saved final receipt names the exact pull-request URL and head commit and binds the public report, private audit, and recovery ZIP. Do not modify or merge the pull request afterward.
```
...
After the pull request has been created, obtain a fresh GitHub observation of its exact URL, number, open state, head branch and commit, base branch and commit, one-commit history, changed-path allowlist, and public-report blob/file hash. Run `bind-publication` with that observation, then rerun `validate-worker`. Save the resulting final publication-bound `locator-audit-worker-receipt.json` and its receipt-bound `locator-audit-worker-recovery.zip` to the existing Library recovery root `/IndexPDF/subject-index-evaluations/oxford-history-french-revolution-2002-original-published-index/workers/locator-audit/CHUNK-017/`, replacing the earlier pre-publication receipt while preserving the canonical filenames. Verify that the saved final receipt names the exact pull-request URL and head commit and binds the public report, private audit, and recovery ZIP. Do not modify or merge the pull request afterward.
```
